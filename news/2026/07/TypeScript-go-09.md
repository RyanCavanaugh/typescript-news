 ...
 * Response Recommended
    ...
    * @bartlomieju provided Deno's use case and workaround for custom URL specifier mapping in [microsoft/TypeScript-go#2824](https://github.com/microsoft/TypeScript-go/issues/2824#issuecomment-4935519462)
 ...
 * [later](https://github.com/microsoft/TypeScript-go/issues/2824#issuecomment-4935519462) **bartlomieju** introduced Deno's need to map custom URL specifiers to declaration files and described their deno sync-types workaround, noting shortcomings in the current paths-based approach
